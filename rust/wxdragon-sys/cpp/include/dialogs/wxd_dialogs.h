...
WXD_EXPORTED void
wxd_FileDialog_GetPaths(const wxd_FileDialog_t* self, const wxd_ArrayString_t* paths);

WXD_EXPORTED int
wxd_FileDialog_GetFilename(const wxd_FileDialog_t* self, char* buffer, size_t bufLen);

WXD_EXPORTED void
wxd_FileDialog_GetFilenames(const wxd_FileDialog_t* self, const wxd_ArrayString_t* filenames);
