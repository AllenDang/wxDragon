...
// WebView event types - only available when webview feature is enabled
    ...
    WXD_EVENT_TYPE_COMMAND_COMBOBOX_DROPDOWN = 410, // wxEVT_COMBOBOX_DROPDOWN
    WXD_EVENT_TYPE_COMMAND_COMBOBOX_CLOSEUP = 411, // wxEVT_COMBOBOX_CLOSEUP
...
typedef struct wxd_GLCanvas wxd_GLCanvas_t;
typedef struct wxd_GLContext wxd_GLContext_t;
typedef struct wxd_GLAttributes wxd_GLAttributes_t;
typedef struct wxd_GLContextAttrs wxd_GLContextAttrs_t;
