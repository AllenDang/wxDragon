...
public:
    ...
    typedef bool (*GetValueFromEditorCtrlCallback)(void* user_data, void* editor,
                                                   wxd_Variant_t* value);
                               ...
                               const wxd_Variant_t* variant)
{
    ...
    case WXD_VARIANT_TYPE_DATETIME: {
        ...
        dt.Set(variant->data.datetime_val.day,
               ...
               variant->data.datetime_val.year, variant->data.datetime_val.hour,
               variant->data.datetime_val.minute, variant->data.datetime_val.second);
        wxVariantValue = dt;
    } break;
    default:
        // Set an empty variant
